...
class MentalHealthDialog extends CancelAndHelpDialog {
    constructor(id) {
        super(id || 'mentalHealthDialog');

        this.addDialog(new TextPrompt(TEXT_PROMPT))
            .addDialog(new ConfirmPrompt(CONFIRM_PROMPT))
            .addDialog(new DateResolverDialog(DATE_RESOLVER_DIALOG))
            .addDialog(new WaterfallDialog(WATERFALL_DIALOG, [
                this.substanceAbuse.bind(this),
    ...
    async substanceAbuse(stepContext) {
        console.log('test');
        return await stepContext.prompt(TEXT_PROMPT, { prompt: 'Do you have a history of substance abuse?' });
    }
...
module.exports.MentalHealthDialog = MentalHealthDialog;
